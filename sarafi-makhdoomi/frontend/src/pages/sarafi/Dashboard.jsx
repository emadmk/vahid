  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
        ...
        <Link to="/sarafi/settlement" className="card p-4 text-center hover:border-gold/50 transition-all border-l-4 border-orange-500">
          <FaCoins className="text-orange-500 text-xl mx-auto mb-2" />
          <p className="text-dark-400 text-xs mb-1">در انتظار وصول</p>
          <p className="text-2xl font-bold text-orange-500">{(tradeStats?.awaitingCurrency || 0) + (tradeStats?.awaitingRial || 0)}</p>
        </Link>
        <Link to="/sarafi/accountant" className="card p-4 text-center hover:border-gold/50 transition-all border-l-4 border-green-500">
          <FaCalculator className="text-green-500 text-xl mx-auto mb-2" />
          <p className="text-dark-400 text-xs mb-1">در انتظار حسابداری</p>
          <p className="text-2xl font-bold text-green-500">{tradeStats?.pendingAccounting || 0}</p>
        </Link>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Link to="/sarafi/instant-trade" className="stat-card hover:border-gold-500/30">
          <FaExchangeAlt className="text-gold-500 text-2xl mb-2" />
          <div className="stat-value">{tradeStats?.totalTrades || 0}</div>
          <div className="stat-label">خرید و فروش فوری</div>
        </Link>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <Link to="/sarafi/instant-trade" className="card p-4 hover:border-gold/50 transition-all flex items-center gap-4">
          <div className="w-12 h-12 rounded-full bg-yellow-500/20 flex items-center justify-center">
            <FaExchangeAlt className="text-yellow-500 text-xl" />
          </div>
          <div>
            <h3 className="font-bold">خرید و فروش فوری</h3>
            <p className="text-dark-400 text-sm">تایید و مدیریت معاملات فوری</p>
          </div>
        ...
        <Link to="/sarafi/pro-trade" className="card p-4 hover:border-gold/50 transition-all flex items-center gap-4">
          <div className="w-12 h-12 rounded-full bg-purple-500/20 flex items-center justify-center">
            <FaChartLine className="text-purple-500 text-xl" />
          </div>
          <div>
            <h3 className="font-bold">خرید و فروش حرفه‌ای</h3>
        ...
        <Link to="/sarafi/accountant" className="card p-4 hover:border-gold/50 transition-all flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-dark-400 text-sm">مدیریت کیف پول و تایید معاملات</p>
          </div>
        </Link>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="card-dark">
          <div className="flex justify-between items-center mb-4">
            ...
            <Link to="/sarafi/instant-trade" className="text-gold-500 text-sm">مشاهده همه</Link>
          </div>
