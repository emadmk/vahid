...
import {
  ...
  FaExclamationCircle, FaUser, FaDownload
} from 'react-icons/fa';
...
const AdminAuditLogs = () => {
  ...
  const exportLogs = async () => {
    toast.success('در حال آماده‌سازی فایل...');
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div>
          ...
          <p className="text-dark-400 text-sm mt-1">نظارت بر تمام عملیات صرافی‌ها</p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
            <div>
              ...
              <select
                ...
                onChange={(e) => handleFilterChange('sarafiId', e.target.value)}
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="p-4 text-gold text-sm">
                        {log.sarafi?.firstName} {log.sarafi?.lastName}
                      </td>
                      <td className="p-4">
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="text-gold">
                    {selectedLog.sarafi?.firstName} {selectedLog.sarafi?.lastName}
                  </p>
                </div>
              </div>
              ...
              <div>
                ...
                <p className="text-white">
                  {selectedLog.user?.firstName} {selectedLog.user?.lastName} ({selectedLog.userRole})
                </p>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                ...
                <div>
                  <label className="text-dark-500">موجودیت هدف</label>
              ...
              {selectedLog.isHighRisk && (
                <div className="bg-red-500/10 border border-red-500/30 rounded-xl p-4 flex items-center gap-3">
                  ...
                  <span className="text-red-500">این عملیات پرخطر است</span>
                </div>
              )}
            </div>
